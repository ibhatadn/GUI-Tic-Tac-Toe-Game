...
a = input("Enter Player One's name : ").title().strip()
b = input("Enter Player Two's name: ").title().strip()
...
def restartGame():
    ...
    for row in range(3):
        for column in range(3):
            cells[row][column].config(text="",bg="#f0f0f0",fg="black")
